...
span.innerHTML = span.innerHTML + ' Franco';
...
// var nuevoTodo = new ToDo("Comprar huevos");
...
function buildToDo(todo, index) {
  ...
  toDoText.id = index;
  // <span id="3">Comprar pan</span>
  if(todo.complete) {
    toDoText.className = 'completeText';
    // <span id="3" class="completeText">Comprar pan</span>
  }
...
// array.map(function(elemt, index) {
//   return elemt + 1
// })
//
// function sumOne(elemnt, index) {
//   return elemnt + 1;
// }
//
// array.map(sumOne)
...
function buildToDos(toDos) {
  ...
  //         | buildToDo({description: "Desc 1", complete: true}, 0)   | buildToDo({description: "Desc 2", complete: false}, 1)
...
function addToDo() {
  ...
  // {description: "aasdasd", complete: false}
